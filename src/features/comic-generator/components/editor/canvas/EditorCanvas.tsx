...
export const EditorCanvas: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-auto bg-gray-100 flex items-center justify-center p-10">
      <div 
        ref={(node) => { dropCanvas(node); }}
        className="bg-white shadow-xl relative transition-transform duration-200 ease-out shrink-0"
        style={{
