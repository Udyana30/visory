...
import { LANGUAGE_OPTIONS, INITIAL_FORM_DATA } from '../utils/constants';
import { formatFileSize, validateAudioFile, formatPayload } from '../utils/utils';
                        ...
                        <div className="border border-gray-200 rounded-lg p-1.5 bg-gray-50">
                            <div className="flex mb-1.5 gap-1">
                                <button
                                    ...
                                    className={`flex-1 py-2.5 px-3 text-sm font-semibold rounded-md transition-all ${mode === 'upload' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-500 hover:text-gray-700'
                                        }`}
                                >
                                    Upload File
                                </button>
                                <button
                                    ...
                                    className={`flex-1 py-2.5 px-3 text-sm font-semibold rounded-md transition-all ${mode === 'record' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-500 hover:text-gray-700'
                                        }`}
                                >
                                    Record Audio
                                </button>
