...
const toolsItems: NavigationItem[] = [
  ...
  { icon: Subtitles, label: 'Speech to Text', href: '/tools/speech-to-text' },
];
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-[#2a2a2a]">
        <Link
          href="/help"
          className={`flex items-center gap-3 px-4 py-2.5 rounded-lg text-gray-400 hover:bg-[#2a2a2a] hover:text-white transition-colors ${isCollapsed ? 'justify-center' : ''
            }`}
